...
def task2():
    ...
    for i in range(1,len(encrypted_message),2): #impair : [1,3,5,...,27]
        decrypted_message+=encrypted_message[i]
    print(decrypted_message)

task2()

def task3(): #encrypt a message whith a step like the romans
    step=3
...
task3()
def task4(): #encrypt a message whith a step like the romans
    step=3
